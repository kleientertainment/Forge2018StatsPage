...
var loc_strings = {
  ...
  "Deutsch": {
    ...
    "progress_lavaarena_armor_hppetmastery": "Imposante flüsternde Rüstung",
    ...
    "leaderboards-title": "Archivierte Bestenliste",
    ...
    "deathless-title": "Ruhmeshalle",
    "deathless-subtitle": "Teams, die den Höllischen Schweinsklops mit 0 Toden besiegten",
    "deathless-date": "Datum",
    "deathless-loading": "Lade...",
    "deathless-noresults": "Keine Resultate gefunden. Versuche es später noch einmal",
    "deathless-showmore": "Zeige mehr",
    "deathless-showless": "Zeige weniger",
    "date": {
      "parentLocale": 'en',
  ...
  "Português PT": {
    ...
    "leaderboards-title": "Classificações Arquivadas",
    ...
    "leaderboards-showless": "Mostrar Menos",
    "deathless-title": "Hall da Fama",
    "deathless-subtitle": "Equipas que derrotaram o Suínoclope Infernal sem casualidades",
    "deathless-date": "Data",
    "deathless-loading": "A actualizar...",
    "deathless-noresults": "Nenhuns resultados obtidos. Tenta novamente mais tarde",
    "deathless-showmore": "Mostrar Mais",
    "deathless-showless": "Mostrar Menos",
    "date": {
      "parentLocale": 'en',
  ...
  "Português BR": {
    ...
    "leaderboards-title": "Placares Arquivados",
    ...
    "leaderboards-showless": "Mostrar Menos",
    "deathless-title": "Hall da fama",
    "deathless-subtitle": "Times que derrotaram o Suínoclope Infernal com 0 mortes.",
    "deathless-date": "Data",
    "deathless-loading": "Carregando...",
    "deathless-noresults": "Nenhum dado obtido.. Tente novamente.",
    "deathless-showmore": "Mostrar Mais",
    "deathless-showless": "Mostrar Menos",
    "date": {
      "parentLocale": 'en',
  ...
  "Srpski (lat)": {
    ...
    "deathless-title": "Dvorana slavnih",
    "deathless-subtitle": "Timovi koji su porazili Vatrenog Svinjaklopa bez umiranja",
    "deathless-date": "Datum",
    "deathless-loading": "Učitavanje...",
    "deathless-noresults": "Nema rezultata.. Pokušajte kasnije",
    "deathless-showmore": "Prikaži više",
    "deathless-showless": "Prikaži manje",
    "date": {
      "parentLocale": 'en',
  ...
  "Srpski (ćir)": {
    ...
    "leaderboards-title": "Најбољи тимови",
    ...
    "deathless-title": "Дворана славних",
    "deathless-subtitle": "Тимови који су поразили Ватреног Свињаклопа без умирања",
    "deathless-date": "Датум",
    "deathless-loading": "Учитавање...",
    "deathless-noresults": "Нема резултата.. Покушајте касније",
    "deathless-showmore": "Прикажи више",
    "deathless-showless": "Прикажи мање",
    "date": {
      "parentLocale": 'en',
  ...
  "Svenska": {
    ...
    "leaderboards-title": "Arkiverad resultattavla",
    ...
    "deathless-title": "De berömdas minnessal",
    "deathless-subtitle": "Lag som besegrat det Infernaliska cyklopsvinet utan att lida någon förlust",
    "deathless-date": "Datum",
    "deathless-loading": "Laddar...",
    "deathless-noresults": "Inga resultat funna. Försök igen senare",
    "deathless-showmore": "Visa fler",
    "deathless-showless": "Visa färre",
    "date": {
      "parentLocale": 'en',
